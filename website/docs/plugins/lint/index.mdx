...
import RecommendedBadge from "@site/src/modules/doc/components/LintRuleList/RecommendedBadge";
import AllBadge from "@site/src/modules/doc/components/LintRuleList/AllBadge";
