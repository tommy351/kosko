...
Run [`kosko generate`](commands.md#generate) to print Kubernetes manifests in the console.
...
If you don't want to print manifests to console, run [`kosko validate`](commands.md#validate).
