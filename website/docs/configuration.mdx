...
#### Examples {#global-import-examples}
...
Plugin configurations. See [Plugins](./plugins/index.md) for more details.
...
[kosko-generate]: ./cli/generate.mdx
[kosko-generate-env]: ./cli/generate.mdx#--env--e
