...
<Image
  img={require("./2022-02-23-kubernetes-models-3.0-released/import-path-before.jpg")}
/>

After:

<Image
  img={require("./2022-02-23-kubernetes-models-3.0-released/import-path-after.jpg")}
/>
