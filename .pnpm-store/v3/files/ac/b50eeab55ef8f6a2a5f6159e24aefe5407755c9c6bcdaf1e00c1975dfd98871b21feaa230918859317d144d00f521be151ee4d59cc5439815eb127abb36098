...
const sharedModuleAliases_1 = __importDefault(require("./sharedModuleAliases"));
const CSS_REGEX = /\.css$/;
...
function createBaseConfig(props, isServer, minify = true) {
    ...
    return {
        ...
        resolve: {
            ...
            alias: Object.assign(Object.assign(Object.assign({}, sharedModuleAliases_1.default), { '@site': siteDir, '@generated': generatedFilesDir }), getDocusaurusAliases()),
