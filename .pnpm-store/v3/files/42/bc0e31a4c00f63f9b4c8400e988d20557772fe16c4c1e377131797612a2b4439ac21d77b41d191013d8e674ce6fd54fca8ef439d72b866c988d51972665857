...
${Object.keys(registry)
    ...
    const codeTranslationsWithFallbacks = Object.assign(Object.assign({}, (await translations_1.getPluginsDefaultCodeTranslationMessages(plugins))), codeTranslations);
