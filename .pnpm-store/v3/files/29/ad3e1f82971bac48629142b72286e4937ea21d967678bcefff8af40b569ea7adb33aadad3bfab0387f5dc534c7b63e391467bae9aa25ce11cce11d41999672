...
async function getPluginsDefaultCodeTranslationMessages(plugins) {
    ...
    return pluginsMessages.reduce((allMessages, pluginMessages) => {
        return Object.assign(Object.assign({}, allMessages), pluginMessages);
    }, {});
}
...
`));
    ...
    return lodash_1.mapValues(extractedCodeTranslations, (messageTranslation, messageId) => {
        var _a;
        return Object.assign(Object.assign({}, messageTranslation), { message: (_a = defaultCodeMessages[messageId]) !== null && _a !== void 0 ? _a : messageTranslation.message });
    });
}
